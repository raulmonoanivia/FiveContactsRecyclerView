...
public class PerfilUsuario_Activity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        // Checagem de o Item selecionado é o de mudanças de contatos
        ...
        // Checagem de o Item selecionado é o de ligar
    ...
    //Função para salvar as modificações do usuário
    public void salvarModificacoes(User user){
        ...
        Toast.makeText(PerfilUsuario_Activity.this,"Alterações Salvas",Toast.LENGTH_LONG).show() ;
